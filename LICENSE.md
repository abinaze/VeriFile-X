...
Required Notice: Copyright (c) 2025 Abinaze Binoy (https://github.com/abinaze/VeriFile-X)
...
## In Plain Language (informal summary — the text above is the actual license)

You are free to use, study, modify, and share VeriFile-X — including its
detection methodology, code, and any research findings derived from it —
for any noncommercial purpose: personal projects, academic research,
coursework, portfolio use, nonprofit and government work, and journalism.

You may not sell VeriFile-X, use it or its output to provide a paid
product or service, or otherwise use it for commercial advantage, without
a separate commercial license from the licensor.

For commercial licensing inquiries, contact the maintainer via the
